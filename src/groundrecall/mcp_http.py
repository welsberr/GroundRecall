...
HANDOFF_WRITE_TOOLS = frozenset({"handoff_propose", "handoff_update_status", "handoff_accept", "handoff_start", "handoff_block", "handoff_complete", "handoff_review", "handoff_review_appeal", "handoff_assignment_request", "handoff_assignment_accept", "handoff_promotion_request", "handoff_promotion_confirm", "handoff_promotion_apply", "handoff_claim", "handoff_release", "progress_append", "result_propose"})
